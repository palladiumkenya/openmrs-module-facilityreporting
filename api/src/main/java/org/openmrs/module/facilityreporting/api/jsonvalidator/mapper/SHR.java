 ...
 */
package org.openmrs.module.facilityreporting.api.jsonvalidator.mapper;
...
public final class SHR {
	...
	@JsonCreator
	public SHR(@JsonProperty("PATIENT_IDENTIFICATION") PATIENT_IDENTIFICATION pATIENT_IDENTIFICATION,
	    @JsonProperty("NEXT_OF_KIN") NEXT_OF_KIN[] nEXT_OF_KIN, @JsonProperty("HIV_TEST") HIV_TEST[] hIV_TEST,
	    @JsonProperty("IMMUNIZATION") IMMUNIZATION[] iMMUNIZATION,
	    @JsonProperty("MERGE_PATIENT_INFORMATION") MERGE_PATIENT_INFORMATION mERGE_PATIENT_INFORMATION,
	...
	public static final class PATIENT_IDENTIFICATION {
		...
		@JsonCreator
		public PATIENT_IDENTIFICATION(@JsonProperty("EXTERNAL_PATIENT_ID") EXTERNAL_PATIENT_ID eXTERNAL_PATIENT_ID,
		    @JsonProperty("INTERNAL_PATIENT_ID") INTERNAL_PATIENT_ID[] iNTERNAL_PATIENT_ID,
		    @JsonProperty("PATIENT_NAME") PATIENT_NAME pATIENT_NAME, @JsonProperty("DATE_OF_BIRTH") String dATE_OF_BIRTH,
		    @JsonProperty("DATE_OF_BIRTH_PRECISION") String dATE_OF_BIRTH_PRECISION, @JsonProperty("SEX") String sEX,
		    @JsonProperty("DEATH_DATE") String dEATH_DATE, @JsonProperty("DEATH_INDICATOR") String dEATH_INDICATOR,
		    @JsonProperty("PATIENT_ADDRESS") PATIENT_ADDRESS pATIENT_ADDRESS,
		    @JsonProperty("PHONE_NUMBER") String pHONE_NUMBER, @JsonProperty("MARITAL_STATUS") String mARITAL_STATUS,
		    @JsonProperty("MOTHER_DETAILS") MOTHER_DETAILS mOTHER_DETAILS) {
		...
		public static final class EXTERNAL_PATIENT_ID {
			...
			@JsonCreator
			public EXTERNAL_PATIENT_ID(@JsonProperty("ID") String iD,
			    @JsonProperty("IDENTIFIER_TYPE") String iDENTIFIER_TYPE,
			    @JsonProperty("ASSIGNING_AUTHORITY") String aSSIGNING_AUTHORITY,
			    @JsonProperty("ASSIGNING_FACILITY") String aSSIGNING_FACILITY) {
				this.iD = iD;
		...
		public static final class INTERNAL_PATIENT_ID {
			...
			@JsonCreator
			public INTERNAL_PATIENT_ID(@JsonProperty("ID") String iD,
			    @JsonProperty("IDENTIFIER_TYPE") String iDENTIFIER_TYPE,
			    @JsonProperty("ASSIGNING_AUTHORITY") String aSSIGNING_AUTHORITY,
			    @JsonProperty("ASSIGNING_FACILITY") String aSSIGNING_FACILITY) {
				this.iD = iD;
		...
		public static final class PATIENT_NAME {
			...
			@JsonCreator
			public PATIENT_NAME(@JsonProperty("FIRST_NAME") String fIRST_NAME,
			    @JsonProperty("MIDDLE_NAME") String mIDDLE_NAME, @JsonProperty("LAST_NAME") String lAST_NAME) {
		...
		public static final class PATIENT_ADDRESS {
			...
			@JsonCreator
			public PATIENT_ADDRESS(@JsonProperty("PHYSICAL_ADDRESS") PHYSICAL_ADDRESS pHYSICAL_ADDRESS,
			    @JsonProperty("POSTAL_ADDRESS") String pOSTAL_ADDRESS) {
			...
			public static final class PHYSICAL_ADDRESS {
				...
				@JsonCreator
				public PHYSICAL_ADDRESS(@JsonProperty("VILLAGE") String vILLAGE, @JsonProperty("WARD") String wARD,
				    @JsonProperty("SUB_COUNTY") String sUB_COUNTY, @JsonProperty("COUNTY") String cOUNTY,
				    @JsonProperty("NEAREST_LANDMARK") String nEAREST_LANDMARK) {
		...
		public static final class MOTHER_DETAILS {
			...
			@JsonCreator
			public MOTHER_DETAILS(@JsonProperty("MOTHER_NAME") MOTHER_NAME mOTHER_NAME,
			    @JsonProperty("MOTHER_IDENTIFIER") MOTHER_IDENTIFIER[] mOTHER_IDENTIFIER) {
			...
			public static final class MOTHER_NAME {
				...
				@JsonCreator
				public MOTHER_NAME(@JsonProperty("FIRST_NAME") String fIRST_NAME,
				    @JsonProperty("MIDDLE_NAME") String mIDDLE_NAME, @JsonProperty("LAST_NAME") String lAST_NAME) {
					this.fIRST_NAME = fIRST_NAME;
					this.mIDDLE_NAME = mIDDLE_NAME;
					this.lAST_NAME = lAST_NAME;
			...
			public static final class MOTHER_IDENTIFIER {
				...
				@JsonCreator
				public MOTHER_IDENTIFIER(@JsonProperty("ID") String iD,
				    @JsonProperty("IDENTIFIER_TYPE") String iDENTIFIER_TYPE,
				    @JsonProperty("ASSIGNING_AUTHORITY") String aSSIGNING_AUTHORITY,
				    @JsonProperty("ASSIGNING_FACILITY") String aSSIGNING_FACILITY) {
					this.iD = iD;
	...
	public static final class NEXT_OF_KIN {
		...
		@JsonCreator
		public NEXT_OF_KIN(@JsonProperty("NOK_NAME") NOK_NAME nOK_NAME, @JsonProperty("RELATIONSHIP") String rELATIONSHIP,
		    @JsonProperty("ADDRESS") String aDDRESS, @JsonProperty("PHONE_NUMBER") String pHONE_NUMBER,
		    @JsonProperty("SEX") String sEX, @JsonProperty("DATE_OF_BIRTH") String dATE_OF_BIRTH,
		    @JsonProperty("CONTACT_ROLE") String cONTACT_ROLE) {
		...
		public static final class NOK_NAME {
			...
			@JsonCreator
			public NOK_NAME(@JsonProperty("FIRST_NAME") String fIRST_NAME, @JsonProperty("MIDDLE_NAME") String mIDDLE_NAME,
	...
	public static final class HIV_TEST {
		...
		@JsonCreator
		public HIV_TEST(@JsonProperty("DATE") String dATE, @JsonProperty("RESULT") String rESULT,
		    @JsonProperty("TYPE") String tYPE, @JsonProperty("FACILITY") String fACILITY,
		    @JsonProperty("STRATEGY") String sTRATEGY, @JsonProperty("PROVIDER_DETAILS") PROVIDER_DETAILS pROVIDER_DETAILS) {
			this.dATE = dATE;
			this.rESULT = rESULT;
			this.tYPE = tYPE;
	...
	public static final class MERGE_PATIENT_INFORMATION {
		...
		@JsonCreator
		public MERGE_PATIENT_INFORMATION(
		    @JsonProperty(value = "PRIOR_INTERNAL_IDENTIFIERS", required = true) PRIOR_INTERNAL_IDENTIFIERS[] pRIOR_INTERNAL_IDENTIFIERS) {
		...
		public static final class PRIOR_INTERNAL_IDENTIFIERS {
			...
			@JsonCreator
			public PRIOR_INTERNAL_IDENTIFIERS(@JsonProperty("ID") String iD,
			    @JsonProperty("IDENTIFIER_TYPE") String iDENTIFIER_TYPE,
			    @JsonProperty("ASSIGNING_AUTHORITY") String aSSIGNING_AUTHORITY,
			    @JsonProperty("ASSIGNING_FACILITY") String aSSIGNING_FACILITY,
			    @JsonProperty("REPLACEMENT_REASON") String rEPLACEMENT_REASON) {
				this.iD = iD;
				this.iDENTIFIER_TYPE = iDENTIFIER_TYPE;
				this.aSSIGNING_AUTHORITY = aSSIGNING_AUTHORITY;
				this.aSSIGNING_FACILITY = aSSIGNING_FACILITY;
	...
	public static final class CARD_DETAILS {
		...
		@JsonCreator
		public CARD_DETAILS(@JsonProperty(value = "STATUS", required = true) String sTATUS,
		    @JsonProperty("REASON") String rEASON, @JsonProperty("LAST_UPDATED") String lAST_UPDATED,
		    @JsonProperty("LAST_UPDATED_FACILITY") String lAST_UPDATED_FACILITY) {
			this.sTATUS = sTATUS;
			this.rEASON = rEASON;
