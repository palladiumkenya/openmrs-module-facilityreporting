...
@Component
public class StringToFacilityReportDatasetConverter implements Converter<String, FacilityReportDataset> {
	
	/**
	 * @see Converter#convert(Object)
	 */
	@Override
	public FacilityReportDataset convert(String id) {
		...
		if (org.apache.commons.lang.StringUtils.isBlank(id)) {
			...
			return service.getDatasetById(Integer.valueOf(id));
		}
		return null;
	}
}
